...
def summary(im_width, im_hight, n_kernels, kernel_size, output_size):
...
softmax = Layers.Dense(cv_w * cv_h * n_kernels, output_size, activate_class=Softmax())


summary(im_width, im_hight, n_kernels, kernel_size, output_size)
